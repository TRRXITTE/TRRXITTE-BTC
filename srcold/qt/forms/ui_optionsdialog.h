...
#if QT_CONFIG(tooltip)
        connectSocksTor->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Bitcoin network through a separate SOCKS5 proxy for Tor hidden services.", nullptr));
#endif // QT_CONFIG(tooltip)
